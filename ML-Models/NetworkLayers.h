...
public:
    ...
    std::vector<double> pre_activation_outputs;

    virtual ~Layer() {} // Virtual destructor for polymorphism

    // Pure virtual function for calculating layer outputs
    virtual void calculateLayerOutputs(std::vector<double> input_vector) = 0;
...
public:
    ...
    void calculateLayerOutputs(std::vector<double> input_vector) override;
...
public:
    ...
    std::vector<double> getActivationOutputs();
